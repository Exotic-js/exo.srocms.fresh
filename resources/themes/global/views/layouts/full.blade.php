...
<head>
    ...
    <link href="https://use.fontawesome.com/releases/v5.15.3/css/all.css" media="screen" rel="stylesheet"
...
<body data-bs-theme="dark">
    ...
    <header class="golden-page-hero"
        style="background-image: url('{{ asset('themes/global/assets/images/herobg.png') }}'); background-size: cover; background-position: center top;">
    ...
    <main>
        <div class="container">
            <div class="row my-4 py-4">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 main-content">
                    @yield('content')
                </div>
            </div>
            <div class="clearfix"></div>
