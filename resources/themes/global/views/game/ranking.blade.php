...
<script type="text/javascript">
    ...
    <style>
        ...
        /* Golden Theme 3x Buttons */
        #rankmenu_container { 
            margin-bottom: 20px; 
            width: 100%;
        }
        #rankmenu_container ul {
            display: flex;
            align-items: center;
        ...
        #rankmenu_container ul li {
            flex: 1; /* evenly divide to 3 columns */
            margin: 0;
        }
        #rankmenu_container ul li a {
            display: block;
            text-align: center;
            ...
            background: linear-gradient(to bottom, #1f170b, #0d0a07);
            transition: all 0.3s;
            border-radius: 3px;
        }
        #rankmenu_container ul li.selected a {
            background: linear-gradient(to bottom, #fcebb6, #c79c4a);
            color: #1a1105;
            border-color: #fcebb6;
            box-shadow: 0 0 12px rgba(201, 160, 91, 0.4);
        }
        #rankmenu_container ul li:hover:not(.selected) a {
